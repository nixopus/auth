export const config = {
  ...
  betterAuthUrl: process.env.BETTER_AUTH_URL || process.env.API_URL || `http://localhost:${parseInt(process.env.PORT || '8080', 10)}`,
  ...
  corsAllowedOrigins: process.env.CORS_ALLOWED_ORIGINS
    ...
    : ['http://localhost:3000', 'http://localhost:7443', 'https://app.nixopus.com', 'https://view.nixopus.com'],
